...
public final class GeofenceUtils {
    ...
    public static final String EXTRA_CONNECTION_ERROR_CODE =
            "com.example.map.EXTRA_CONNECTION_ERROR_CODE";

    public static final String EXTRA_CONNECTION_ERROR_MESSAGE =
            "com.example.map.EXTRA_CONNECTION_ERROR_MESSAGE";

    public static final String EXTRA_GEOFENCE_STATUS =
            "com.example.map.EXTRA_GEOFENCE_STATUS";

    /*
     * Keys for flattened geofences stored in SharedPreferences
     */
    public static final String KEY_LATITUDE = "com.example.map.KEY_LATITUDE";

    public static final String KEY_LONGITUDE = "com.example.map.KEY_LONGITUDE";

    public static final String KEY_RADIUS = "com.example.map.KEY_RADIUS";

    public static final String KEY_EXPIRATION_DURATION =
            "com.example.map.KEY_EXPIRATION_DURATION";

    public static final String KEY_TRANSITION_TYPE =
            "com.example.map.KEY_TRANSITION_TYPE";
