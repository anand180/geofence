...
public class GeofenceRequester
    ...
    public void onAddGeofencesResult(int statusCode, String[] geofenceRequestIds) {
        ...
        if (LocationStatusCodes.SUCCESS == statusCode) {
            ...
            Timber.d(GeofenceUtils.APPTAG, msg);
            ...
            // Log an error
            Timber.e(GeofenceUtils.APPTAG, msg);
    ...
    public void onConnected(Bundle arg0) {
        ...
        Timber.d(GeofenceUtils.APPTAG, mActivity.getString(R.string.connected));
...
//        mLocationClient.setMockLocation(newLocation);
    ...
    public void onDisconnected() {
        ...
        Timber.d(GeofenceUtils.APPTAG, mActivity.getString(R.string.disconnected));
