 ...
 */
public class BasicGeoFenceStore {
    ...
    public BasicGeoFenceStore(Context context) {
        mPrefs =
     ...
     * {@link BasicGeoFence}
     */
    public BasicGeoFence getGeofence(String id) {
        ...
        if (
            ...
            return new BasicGeoFence(id, lat, lng, radius, expirationDuration, transitionType);
     ...
     * @param geofence The {@link BasicGeoFence} containing the
     * values you want to save in SharedPreferences
     */
    public void setGeofence(String id, BasicGeoFence geofence) {
